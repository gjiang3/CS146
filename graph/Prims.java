...
public class Prims
{
    ...
    {
    	int[][] tempMatrix = new int [numberofvertices+1][numberofvertices+1];
        
        for (int vertex = 2; vertex <= numberofvertices; vertex++)
        {
            
        	tempMatrix[parent[vertex]][vertex] = adjacencyMatrix[parent[vertex]][vertex];
        	tempMatrix[vertex][parent[vertex]] = adjacencyMatrix[parent[vertex]][vertex];
        }
        System.out.println("The minimum spanning tree in table representation is: ");
        System.out.print("  ");
        ...
        for (int source = 1; source <= numberofvertices; source++)
        {
            ...
            {
            	String temp = "";
            	if(tempMatrix[source][destination] > 9)
            	{
            		temp = tempMatrix[source][destination] + "";
            	}
            	else
            	{
            		temp = " " + tempMatrix[source][destination];
                ...
                total += tempMatrix[source][destination];
            }
            
            System.out.println();
        }  
        System.out.println("Total weight: " + (total/2));
    }
